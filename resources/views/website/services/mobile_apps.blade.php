...
<div class="l-titlebar imgsize_cover size_large color_alternate">
	...
	<div class="g-nav">
		...
		<a class="g-nav-item to_next" title="Mobile Applications Design"
		   href="{{url('/service',['payment_integration'])}}"></a>
		<a
		    class="g-nav-item to_prev" title="Enterprise Software Design"
		    href="{{url('/service',['enterprise_software'])}}"></a></div>
	</div>
    </div>
</div>
<div class="l-main">
		...
		<div class="l-section-h i-cf">
			...
			<div class="in_col-sm-6 wpb_column in_column_container in_col-has-fill  vc_custom_1437658268320">
				...
				<div class="vc_empty_space  blank-column" style="height: 10px">
				    <p>Do you need a mobile application ? <button class="w-btn-label" href="<?= url('//contact_us') ?>"> contact us now</button> or view <a href="https://play.google.com/store/apps/details?id=com.pspftz.pspftz" target="_blank">some of our mobile apps</a></p>
				</div>
			    </div>
			</div>
			<div class="in_col-sm-6 wpb_column in_column_container">
...
<div class="l-navigation">
    <a class="l-navigation-item to_next" href="{{url('/service',['payment_integration'])}}">
    ...
    <a class="l-navigation-item to_prev" href="{{url('/service',['enterprise_software'])}}">
	<div class="l-navigation-item-arrow"></div>
	<div class="l-navigation-item-preview">
