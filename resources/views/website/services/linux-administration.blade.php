...
@section('content')
        ...
        <div class="l-titlebar-h">
            ...
            <div class="g-nav">
                <div class="g-nav-list"><a class="g-nav-item to_next" title="Database Design"
                                           href="{{url('/service',['database-design'])}}"></a><a
                            class="g-nav-item to_prev" title="Payment Integration"
                            href="{{url('/service',['payment-integration'])}}"></a></div>
            </div>
        </div>
    </div>
    <div class="l-main">
    ...
    <div class="l-navigation">
        <a class="l-navigation-item to_next" href="{{url('/service',['database-design'])}}">
        ...
        <a class="l-navigation-item to_prev" href="{{url('/service',['payment-integration'])}}">
            <div class="l-navigation-item-arrow"></div>
            <div class="l-navigation-item-preview">
