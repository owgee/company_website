...
@section('content')
    <div class="l-titlebar imgsize_cover size_large color_alternate">
        <div class="l-titlebar-h">
            ...
            <div class="g-nav">
                <div class="g-nav-list"><a class="g-nav-item to_next" title="Enterprise Software"
                                           href="{{url('/service',['enterprise-software'])}}"></a><a
                            class="g-nav-item to_prev" title="Linux Administration"
                            href="{{url('/service',['linux-administration'])}}"></a></div>
            </div>
        </div>
    </div>
    <div class="l-main">
    ...
    <div class="l-navigation">
        <a class="l-navigation-item to_next" href="{{url('/service',['enterprise-software'])}}">
        ...
        <a class="l-navigation-item to_prev" href="{{url('/service',['linux-administration'])}}">
            <div class="l-navigation-item-arrow"></div>
            <div class="l-navigation-item-preview">
