                        ...
                        <div class="g-cols offset_medium">
                            <div class="in_col-sm-12 wpb_column in_column_container">
                                <div class="in_column-inner">
                                    <div class="w-tabs layout_timeline icon_chevron iconpos_right ">
                                        <div class="w-tabs-list items_5">
                                            <div class="w-tabs-list-h">
                                                <div class="w-tabs-item active"><a href="#1377359144-1-100"
                                                                                   class="w-tabs-item-h"><span
                                                                class="w-tabs-item-title">2012</span></a></div>
                                                <div class="w-tabs-item"><a href="#1377359144-2-22"
                                                                            class="w-tabs-item-h"><span
                                                                class="w-tabs-item-title">2013</span></a></div>
                                                <div class="w-tabs-item"><a href="#1377362430608-5-10"
                                                                            class="w-tabs-item-h"><span
                                                                class="w-tabs-item-title">2014</span></a></div>
                                                <div class="w-tabs-item"><a href="#1377361385075-3-7"
                                                                            class="w-tabs-item-h"><span
                                                                class="w-tabs-item-title">2015</span></a></div>
                                                <div class="w-tabs-item"><a href="#1377361739055-4-7"
                                                                            class="w-tabs-item-h"><span
                                                                class="w-tabs-item-title">2016</span></a></div>
                                            </div>
                                        </div>
                                                                    ...
                                                                    <div class="in_column-inner">
                                                                        <div class="wpb_text_column ">
                                                                            <div class="wpb_wrapper">
                                                                                <h4>Our Birth</h4>
                                                                                <p>Our company was officially registered
                                                                                    in July 2012 under BRELA in Tanzania
                                                                                    and started
                                                                ...
                                                                <div class="in_col-sm-4 wpb_column in_column_container">
                                                                    <div class="in_column-inner">
                                                                        <div class="w-image  align_center"><img
                                                                                    ...
                                                                                    src="{{url('/')}}/website_assets/uploads/about.png"
                                                                                    class="attachment-large size-large"
                                                                                    alt="INETS in 2012"
                                                                                    srcset="{{url('/')}}/website_assets/uploads/about.png"
                                ...
                                <div class="in_column-inner">
                                    <div class="wpb_text_column ">
                                        <div class="wpb_wrapper">
                                            ...
                                            <p style="text-align: center">We love what we do and we do it with
                                                passion</p>
                                        </div>
                                    ...
                                    <div class="g-cols wpb_row offset_medium vc_inner ">
                                        <div class="in_col-sm-3 wpb_column in_column_container animate_afb">
                                            <div class="in_column-inner">
                                                <div class="w-person layout_flat" itemscope="itemscope"
                                                     itemtype="https://schema.org/Person">
                                                    <div class="w-person-image"><a class="w-person-link" href="#"><img
                                                                    src="{{url('/')}}/website_assets/uploads/ephraim.png"
                                                                    width="350" height="350" alt="Ephraim Swilla"
                                                                    itemprop="image"></a></div>
                                                    <div class="w-person-content"><a class="w-person-link" href="#"><h4
                                                                    class="w-person-name" itemprop="name"><span>Ephraim Swilla</span>
                                                            </h4></a>
                                                        <div class="w-person-role" itemprop="jobTitle">CEO</div>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="in_col-sm-3 wpb_column in_column_container animate_afb d1">
                                            <div class="in_column-inner">
                                                <div class="w-person layout_flat" itemscope="itemscope"
                                                     itemtype="https://schema.org/Person">
                                                    <div class="w-person-image"><a class="w-person-link" href="#"><img
                                                                    src="{{url('/')}}/website_assets/uploads/erick.png"
                                                                    width="350" height="350" alt="Erick Chrysostom"
                                                                    itemprop="image"></a></div>
                                                    <div class="w-person-content"><a class="w-person-link" href="#"><h4
                                                                    class="w-person-name" itemprop="name"><span>Erick Chrysostom</span>
                                                            </h4></a>
                                                        <div class="w-person-role" itemprop="jobTitle">CTO
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="in_col-sm-3 wpb_column in_column_container animate_afb d2">
                                            <div class="in_column-inner">
                                                <div class="w-person layout_flat" itemscope="itemscope"
                                                     itemtype="https://schema.org/Person">
                                                    <div class="w-person-image"><a class="w-person-link" href="#"><img
                                                                    src="{{url('/')}}/website_assets/uploads/amani.png"
                                                                    width="350" height="350" alt="Amani Mwakilasa"
                                                                    itemprop="image"></a></div>
                                                    <div class="w-person-content"><a class="w-person-link" href="#"><h4
                                                                    class="w-person-name" itemprop="name"><span>Amani Mwakilasa</span>
                                                            </h4></a>
                                                        <div class="w-person-role" itemprop="jobTitle">CFO</div>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="in_col-sm-3 wpb_column in_column_container animate_afb d3">
                                            <div class="in_column-inner">
                                                <div class="w-person layout_flat" itemscope="itemscope"
                                                     itemtype="https://schema.org/Person">
                                                    <div class="w-person-image"><a class="w-person-link" href="#"><img
                                                                    src="{{url('/')}}/website_assets/uploads/yohana.png"
                                                                    width="350" height="350" alt="Yohana Nasson"
                                                                    itemprop="image"></a></div>
                                                    <div class="w-person-content"><a class="w-person-link" href="#"><h4
                                                                    class="w-person-name" itemprop="name"><span>Yohana Nasson</span>
                                                            </h4></a>
                                                        <div class="w-person-role" itemprop="jobTitle">CIO</div>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                        ...
                        <div class="g-cols offset_medium">
                            <div class="in_col-sm-12 wpb_column in_column_container">
                                <div class="in_column-inner">
                                    <div class="wpb_text_column ">
                                        <div class="wpb_wrapper">
                                            <h2 style="text-align: center">Our <strong>Passion</strong> for what we do
                                                is rendered in our <strong>Services</strong></h2>
                                        </div>
                                    </div>
