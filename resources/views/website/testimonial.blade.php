                                ...
                                <div class="vc_column-inner">
                                    <div class="wpb_text_column ">
                                        <div class="wpb_wrapper">
                                            <h2 style="text-align: center">From : Public Services Pension Fund
                                                (PSPF)</h2>
                                        </div>
                                    </div>
                                    ...
                                    <div class="wpb_text_column ">
                                        <div class="wpb_wrapper">
                                            <h2 style="text-align: center">From : Business Registrations and Licensing
                                                Agency (BRELA)</h2>
                                        </div>
                                    </div>
                                    <div class="w-separator type_invisible size_medium thick_1 style_solid color_border cont_none">
                                            ...
                                            <div class="vc_column-inner">
                                                <div class="w-testimonial style_2">
                                                    <blockquote><q class="w-testimonial-text">We highly appreciate these
                                                            people toward success of this project (OBRS) which highly
