	...
	<main class="l-content" itemprop="mainContentOfPage">
			...
			<div class="in_col-sm-6 wpb_column in_column_container">
				...
				<div class="wpb_text_column ">
					...
					<ul>
					    ...
					    <li><a href="<?= url('/new/product/stock') ?>">Stock/Inventory Management system</a></li>
					    <li><a href="<?= url('/new/product/shulesoft') ?>">School Management system</a></li>
					    <li><a href="<?= url('/new/product/file_tracking') ?>">File tracking software system</a></li>
		...
		<div class="l-section-h i-cf">
			...
			<div class="in_col-sm-6 wpb_column in_column_container in_col-has-fill  vc_custom_1437658268320">
				...
				<div class="vc_empty_space  blank-column" style="height: 10px">
				    <p>Do you need any custom software system for your organization ?,<a href="<?= url('/new/contact_us') ?>"> contact us now</a></p>
				</div>
			    </div>
			</div>
			<div class="in_col-sm-6 wpb_column in_column_container">
		...
		<div class="l-section-h i-cf">
			...
			<div class="in_col-sm-6 wpb_column in_column_container in_col-has-fill  vc_custom_1437658268320">
			    ...
			    <div class="in_column-inner">
				<div class="vc_empty_space  blank-column" style="height: 10px"><span
					class="vc_empty_space_inner">View our customer <a href="<?= url('/new/testimonial') ?>"> testimonials here </a></span>
