                            ...
                            <div class="in_col-sm-8 wpb_column in_column_container">
                                <div class="in_column-inner">
                                    <div class="w-image  align_center animate_afb"><img width="750" height="1000"
                                                                                        src="../../wp-content/uploads/2014/09/vesper_by_alexandreev-d79vil6.jpg"
                                        ...
                                        <div class="w-tabs-sections">
                                            <div class="w-tabs-sections-h">
                                                        ...
                                                        <div class="w-tabs-section-content-h i-cf">
                                                            <div class="wpb_text_column ">
                                                                <div class="wpb_wrapper"><p>Lorem ipsum dolor sit amet,
                                                                        ...
                                                                        vel interdum mi sapien ut justo. Nulla varius
                                                                        consequat magna, id molestie ipsum volutpat
                                                                        quis.</p>
                                                                    <blockquote><p>At delectus doloremque dolores
                                                                            explicabo laudantium minima qui. Animi aperiam
                                                                            aspernatur atque debitis distinctio impedit
                                                                            inventore iure labore modi omnis, optio rerum ut
                                                                            veritatis voluptatum?</p></blockquote>
                                                                    </p></div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                        ...
                                                        <div class="w-tabs-section-content-h i-cf">
                                                            <div class="wpb_text_column ">
                                                                <div class="wpb_wrapper"><p>Lorem ipsum dolor sit amet,
                                                                        consectetur adipiscing elit. Morbi sagittis, sem
                                                                        quis lacinia faucibus, orci ipsum gravida tortor,
                                                                        vel interdum mi sapien ut justo. Etiam facilisis
                                                                        venenatis libero, ac fermentum dolor euismod in.
                                                                        Phasellus placerat egestas varius. Vivamus eleifend
                                                                        at massa sodales faucibus. Vestibulum egestas nibh
                                                                        in turpis volutpat ornare.</p></div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="w-tabs-section active">
                                                    <div class="w-tabs-section-header">
                                                        <div class="w-tabs-section-header-h"><h5
                                                                    class="w-tabs-section-title">Additional Few Things</h5>
                                                            <div class="w-tabs-section-control"></div>
                                                        </div>
                                                    </div>
                                                    <div class="w-tabs-section-content">
                                                        <div class="w-tabs-section-content-h i-cf">
                                                            <div class="wpb_text_column ">
                                                                <div class="wpb_wrapper"><p>Etiam facilisis venenatis
                                                                        ...
                                                                        placerat egestas varius. Vivamus eleifend at massa
                                                                        sodales faucibus. Vestibulum egestas nibh in turpis
                                                                        volutpat ornare. Ut tempor lacinia purus, ac gravida
                                                                        tortor suscipit eget. Maecenas ornare imperdiet.
                                                                        Nullam et faucibus bibendum ante.</p></div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
