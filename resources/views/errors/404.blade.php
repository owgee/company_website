...
@section('content')
    ...
    <div class="l-titlebar imgsize_cover parallax_ver size_huge color_primary">
        ...
        <div class="l-titlebar-h">
            <div class="l-titlebar-content"><h1 itemprop="headline">404</h1></div>
            <div class="g-breadcrumbs" xmlns:v="http://rdf.data-vocabulary.org/#"><span typeof="v:Breadcrumb"><a
                ...
                <span class="g-breadcrumbs-separator"></span> <span class="g-breadcrumbs-item">This page is not available</span>
            </div>
	    <p>Please type the url correctly or please contact us now</p>
        </div>
    </div>
    <div class="l-main">
