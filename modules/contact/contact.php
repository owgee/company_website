<div class="text-heading">
            <h1>Let's <span class="highlight"> know</span> your need</h1>
            <p>Tell us what solution you need for <span>for your business or any custom solution</span></p>
        </div>
<div class="container">
            <div class="row">
...
send_info=function(){
    ...
    $.get('<?=$AJAX?>',{pg:'contact',process:'contact',message:message,name:name,email:email,news:news},function(data){
	 $('#loading').html(data);
    });
}
</script>