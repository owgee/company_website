...
<div class="container">
    ...
    <div class="row-fluid">
	<div class="span3">
	    <div class="row-fluid"><section id="nav_menu-3" class="widget-side span12 widget_nav_menu"><div class="menu-side-menu-container"><ul id="menu-side-menu" class="menu nav nav-list"><li id="menu-item-1838" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-1838 first"><a href="http://preview.themique.com/ventus/pages/about/">ABOUT</a></li>
	...
	<div class="span9">
		...
		<div class="span12">
			...
			<div class="span10">
			    <h1 class="portfolio-heading-h1">Project #10 – Slideshow</h1>
			</div>
			<div class="span2">
		...
		<div class="span12">
			...
			<div class="span8">
			    <div class="content-bubble drop-shadow curved text-left">
				<h6 class="heading"><strong>THE RESULT</strong></h6>
			...
			<div class="span4">
				...
				<p>css, javascript, photography</p>
			    </div>
			    <div class="content-bubble-triangle"></div>
			</div>										
		    </div>
		    <p>Nullam eget tortor orci. Quisque pellentesque nisi ac sem faucibus, eget luctus orci commodo. Suspendisse eget libero vitae eros scelerisque vulputate. Donec quis placerat turpis. Sed non ultricies elit, sed euismod ligula. Integer lorem lectus, faucibus at elit nec, auctor euismod metus. Vestibulum adipiscing urna laoreet imperdiet faucibus. Etiam a lacus sem. Nullam lobortis leo sed fringilla pulvinar.</p>
