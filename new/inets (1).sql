...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 10, 2014 at 11:49 PM
...
--
-- Table structure for table `inets_image`
--

CREATE TABLE IF NOT EXISTS `inets_image` (
  `image_id` int(11) NOT NULL AUTO_INCREMENT,
  `image_link` varchar(120) NOT NULL,
  `image_project_id` int(11) NOT NULL,
  `image_caption` text NOT NULL,
  `image_time` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `image_service_id` int(11) NOT NULL,
...
--
-- Table structure for table `inets_job`
--

CREATE TABLE IF NOT EXISTS `inets_job` (
  `job_id` int(11) NOT NULL AUTO_INCREMENT,
  `job_name` varchar(40) NOT NULL,
  `job_description` text NOT NULL,
  `job_skills` text NOT NULL,
  `job_uploaded_time` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
...
--
-- Dumping data for table `inets_job`
--

INSERT INTO `inets_job` (`job_id`, `job_name`, `job_description`, `job_skills`, `job_uploaded_time`, `job_deadline`, `job_vacancy`) VALUES
(1, 'Public relation and marketing', 'Experienced person with vision and motivation ', 'Bachelor degree in Marketing or public relation', '2014-09-10 20:09:05', '2014-10-31 00:00:00', 1);
...
CREATE TABLE IF NOT EXISTS `inets_project` (
  ...
  `project_invest` int(11) NOT NULL DEFAULT '1' COMMENT '1=accept investment, 0=none',
  `project_clients` text NOT NULL,
  `project_link` varchar(90) NOT NULL,
...
INSERT INTO `inets_service` (`service_id`, `service_name`, `service_description`, `service_image`, `service_skills`) VALUES
(1, 'SOFTWARE DESIGN AND DEVELOPMENT', 'We design and develop website  and web application via international standards and engineering ethics to meet your needs.', '', ''),
...
CREATE TABLE IF NOT EXISTS `inets_user` (
  ...
  `user_picture` varchar(120) NOT NULL,
...
INSERT INTO `inets_user` (`user_id`, `user_firstname`, `user_lastname`, `user_gender`, `user_email`, `user_password`, `user_position`, `user_task`, `user_phone_number`, `user_picture`, `user_skills`, `user_time`, `user_country`, `user_location`, `user_collage`, `user_role_id`) VALUES
